...
//                 // Nota: unproject devuelve una matriz 1x3, la transponemos a Vector3f (3x1)
...
//                 // Añadir observaciones al grafo del Mapa (relacionar el ID del KF con el ID del MP)
//                 pMap_->insertMapPoint(pNewMP);

//                 // 2. Ahora sí, añadir observaciones al grafo del Mapa
//                 pMap_->addObservation(currKeyFrame_->getId(), pNewMP->getId(), idx1);
//                 pMap_->addObservation(pKF->getId(), pNewMP->getId(), idx2);

//                 // Vincular el MapPoint a los KeyFrames (esto puede ir antes o después de lo de arriba)
//                 currKeyFrame_->setMapPoint(idx1, pNewMP);
//                 pKF->setMapPoint(idx2, pNewMP);
